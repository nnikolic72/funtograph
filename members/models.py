...
class Member(models.Model):
    ...
    instagram_handle_verified = models.BooleanField(default=False, null=True, blank=True,
                                                    verbose_name=_('Instagram handle verified'),
                                                    help_text=_('Checked if mods verified member''s Instagram handle')
    )
    eyeem_handle_verified = models.BooleanField(default=False, null=True, blank=True,
                                                verbose_name=_('EyeEm handle verified'),
                                                help_text=_('Checked if mods verified member''s EyeEm handle')
    )

    facebook_url_verified = models.BooleanField(default=False, null=True, blank=True,
...
class Membership(models.Model):
    ...
    active_membership = models.BooleanField(default=False, null=True, blank=True,
